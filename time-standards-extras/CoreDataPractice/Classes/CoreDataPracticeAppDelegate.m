...
@implementation CoreDataPracticeAppDelegate
...
- (NSFetchedResultsController *) fetchedResultsController {
	...
	[fetchRequest setEntity:[NSEntityDescription entityForName:@"Swimmer" 
...
- (NSManagedObject *) getHomeScreenObject: (NSString *)relationshipName 
	...
	if (homeScreenValue == nil) {
		homeScreenValue = [NSEntityDescription insertNewObjectForEntityForName:@"HomeScreenValues" 
																		  inManagedObjectContext:[self managedObjectContext]];
		swimmer = [NSEntityDescription insertNewObjectForEntityForName:entityName 
												inManagedObjectContext:[self managedObjectContext]];
		[swimmer setValue:defaultValue forKey:defaultKey];
		[homeScreenValue setValue:swimmer forKey:relationshipName];
	}
	else {
		swimmer = [homeScreenValue valueForKey:relationshipName];
	}
