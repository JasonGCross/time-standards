//
//  pList_PersistenceAppDelegate.m
//  pList Persistence
//
...
#import "pList_PersistenceAppDelegate.h"
#import "HomeScreenValues.h"
#import "Swimmer.h"
#import "PickerValues.h"

@implementation pList_PersistenceAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	homeScreenValues = [[HomeScreenValues alloc] init];
	...
	if([NSKeyedArchiver archiveRootObject:homeScreenValues toFile:[self dataFilePath]] == NO) {
